    ...
    return (
        <Container fluid>
            <Row className="justify-content-md-center my-5">
                <h2>{t("bibliography.header")}</h2>
            </Row>

            <Row>
                <Col sm={6}>
                    <Image src="/static/img/misc/bibliography-image.jpeg" rounded fluid />
                </Col>
                <Col sm={6}>
                    <Card className="my-3">
                        <Card.Header as="h3">{t("bibliography.collections.title")}</Card.Header>
                        <Card.Body>
                            <p>
                        ...
                        <Row>
                            <Col lg={12}>
                                <Card className="my-5">
                                    <Card.Header as="h3">{t("bibliography.scholarship.title")}</Card.Header>
                                    <Card.Body>
                                        <p> 
